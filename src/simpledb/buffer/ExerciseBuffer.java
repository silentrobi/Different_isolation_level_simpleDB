...
public class ExerciseBuffer{
    ...
    */
     public Block assignToNew(String filename, PageFormatter fmtr) { /* modified ---> return blk */
      flush();
     ...
     public String toString(){
    	 return "Buffer: "+ bufferID + " block no: "+ blk.number()+ " pinned: "+ isPinned()+ "\n";
     }
}