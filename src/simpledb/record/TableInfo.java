...
public class TableInfo {
   ...
   public TableInfo(String tblname, Schema schema) {
      ...
      recordlen = pos; // return record size
   }
    ...
    */
   public TableInfo(String tblname, Schema schema, Map<String,Integer> offsets, int recordlen) { // getting info (type, record size) from existing table
      this.tblname   = tblname;
      this.schema    = schema;
